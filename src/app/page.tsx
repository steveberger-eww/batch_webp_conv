...
//   const handleUpload = async (acceptedFiles: File[]) => {
//     const webpPromises = acceptedFiles.map(async (file) => {
//       const buffer = await file.arrayBuffer();
//       const webpBuffer = await convertToWebp(Buffer.from(buffer));
//       return { name: file.name, webpBuffer };
//     });

//     const webpImagesData = await Promise.all(webpPromises);
//     setWebpImages(webpImagesData);
//   };
